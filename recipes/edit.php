    ...
    <div class="col-12 col-lg-9 col-xl-8">
      ...
      <form method="post" class="section-card p-3 p-md-4" onsubmit="return requestPinAndSubmit(this)">
        ...
        <div class="d-flex gap-2 justify-content-between">
          ...
          <button class="btn btn-danger" type="submit" formaction="?slug=<?= urlencode($slug) ?>" formmethod="post" name="action" value="delete_recipe" onclick="return requestPinAndSubmit(this.form, true)">Delete</button>
        </div>
      </form>
    </div>
  </div>
...
function requestPinAndSubmit(form, isDelete) {
  const pin = prompt(isDelete ? 'Enter PIN to delete this recipe' : 'Enter PIN to save changes');
